...
import { Mail, Lock, User, ArrowRight, Loader2, ShieldCheck, Star } from 'lucide-react';
                ...
                >
                    <div className="mb-12">
                        <div className="flex items-center space-x-2 mb-4">
                            ...
                            <span className="text-[10px] font-black uppercase tracking-widest text-slate-400">Account Creation</span>
                        </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="pt-8 border-t border-orange-50 flex justify-center items-center space-x-2">
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Already have an account?</p>
                            <Link to="/login?role=user" className="text-xs font-black text-orange-600 uppercase tracking-widest hover:text-orange-700">Login Instead</Link>
                        </div>
                    </form>
                </motion.div>
            </div>
